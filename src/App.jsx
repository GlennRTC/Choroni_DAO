...
if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>⛱ Choroní DAO ⛱ Member Page</h1>
        <p>Congratulations on being a member of Choroni DAO</p>
        <div>
          <div>
            <h2>Member List</h2>
